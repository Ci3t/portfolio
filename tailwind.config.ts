...
import svgToDataUri from "mini-svg-data-uri"; // Use ES6 import instead of require
...
const config: Config = {
  ...
  theme: {
    ...
    extend: {
      backgroundImage: {
        "dot-black": "radial-gradient(circle, black 1px, transparent 1px)", // Black dots
        "dot-white": "radial-gradient(circle, white 1px, transparent 1px)", // White dots
      },
      colors: {
        black: {
          "100": "#000319",
